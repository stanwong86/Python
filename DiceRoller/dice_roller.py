...
you if you'd like to roll again. For this project, you'll need to set the min and max number that your dice can produce. 
For the average die, that means a minimum of 1 and a maximum of 6. You'll also want a function that randomly grabs a 
...
def main():
	min_num = 1
	max_num = 6
	dice_result = random.randint(min_num, max_num)
